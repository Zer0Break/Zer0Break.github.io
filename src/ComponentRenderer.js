...
import LandingPageImageSrc from "images/demo/RestaurantLandingPage.jpeg";
...
import Searcher from "components/misc/Searcher.js";
import Select4 from "components/misc/Select4.js";
...
//Imagenes
import MainLandingPageImageSrc from "images/demo/HostingCloudLandingPage.jpeg";
import EvaluadorPageImageSrc from "images/demo/HostingCloudLandingPage.jpeg";
...
export const components = {
  landingPages: {
    ...
    //   imageSrc: LandingPageImageSrc,
    //   url: "/components/landingPages/RestaurantLandingPage",
    // },
    //copy the element below and paste it above the comment to add a new landing page but called MainLandingPage
    MainLandingPage: {
      component: MainLandingPage,
      imageSrc: MainLandingPageImageSrc,
      url: "/components/landingPages/MainLandingPage",
    },
    //now make a new element for EvaluadorLandingPage
    EvaluadorPage: {
      component: EvaluadorPage,
      imageSrc: EvaluadorPageImageSrc,
      url: "/components/landingPages/Evaluador",
    },
    //now make a new element for Searcher
    Searcher: {
      component: Searcher,
      imageSrc: EvaluadorPageImageSrc,
      url: "/components/landingPages/Searcher",
    },
    Select4: {
      component: Select4,
      imageSrc: EvaluadorPageImageSrc,
      url: "/components/landingPages/Select4",
    },
