...
`;
//esta de abajo es para los links que no se pueden clickear
export const UnableNavLink = tw.a`
  text-lg my-2 lg:text-sm lg:mx-6 lg:my-0
  font-semibold tracking-wide transition duration-300
  pb-1 border-b-2 border-transparent hover:border-primary-500 hocus:text-primary-500
`;
...
export const MobileNavLinksContainer = tw.nav`flex flex-1 pb-8 items-center justify-between`;
...
export const DesktopNavLinks = tw.nav`
  hidden lg:flex flex-1 justify-between items-center pb-8
`;
...
export default ({ roundedHeaderButton = false, logoLink, links, className, collapseBreakpointClass = "lg" }) => {
  ...
  const defaultLogoLink = (
    <LogoLink href="/">
      <Image src={Logo} alt="logo" height={108} width={108} priority={true}/>
    </LogoLink>
  );
